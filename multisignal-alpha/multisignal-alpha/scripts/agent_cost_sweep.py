...
def main():
    ...
    for c in COSTS:
        ...
        rows.append({"cost_bps": c, "learned_gamma": a.gamma_,
                     ...
                     "advantage": sharpe_ann(ag["net"]) - sharpe_ann(my["net"]),
    ...
    axes[0].set_xlabel("cost (bps per side)"); axes[0].set_ylabel("learned gamma")
